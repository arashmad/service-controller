...
set GEOSERVER_HOME=C:\Program Files (x86)\Geoserver 2.17 Master
...
:run
  ...
  echo.
  "%RUN_JAVA%" %JAVA_OPTS% -DGEOSERVER_DATA_DIR="%GEOSERVER_DATA_DIR%" -DCLUSTER_CONFIG_DIR="C:\Program Files (x86)\Geoserver 2.17 Master\data_dir\cluster\master" -Djava.awt.headless=true -DSTOP.PORT=8079 -DSTOP.KEY=geoserver -jar start.jar
  cd bin
goto end
